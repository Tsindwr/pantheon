import type { PotentialKey } from "../potentials.js";
import type { SuccessLevelKey } from "../rules/success-levels.js";
export type { SuccessLevelKey };
export type RollMode = "normal" | "advantage" | "disadvantage";
export type RiskinessLevel = "uncertain" | "risky" | "dire" | "desperate";
export declare const RISKINESS_LABELS: Record<RiskinessLevel, string>;
...
export type VolatilityDieType = 4 | 6 | 8 | 10 | 12;
export type PerkId = "anchor-point" | "implode" | "refresh" | "spark" | "cleave" | "drive" | "momentum" | "stabilize" | "reversal" | "spite" | "burn" | "fracture" | "tempt" | "charge";
export type PerkCategory = "modifier" | "die-transform" | "track" | "damage" | "resource" | "charge" | "meta";
export type PerkTiming = "on-kept-die" | "after-success-level" | "manual-choice" | "passive";
