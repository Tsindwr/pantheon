...
const RISKINESS_MAP: Map<RiskinessLevel, number> = new Map<
    RiskinessLevel,
    number
>([
    ["uncertain", 0],
...
export function validateVolatilityFace(face: number, dieType: number): void {
...
export function resolveVolatilityModifier(
...
export function calculateTotalVolatility(
