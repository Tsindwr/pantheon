...
export const BASE_PERKS = {
    ...
    implode: {
        ...
        timing: "on-kept-die",
        description: "If your Volatility Die is not already a D4, roll one die level lower and take that result.",
        shortLabel: "Implode",
        resolve: (context) => ({
            reroll: {
    ...
    spark: {
        ...
        timing: "passive",
        passive: true,
        description: "Takes up a slot and reduces the cost of Charging this Volatility Die by 2 Beats.",
        shortLabel: "Spark",
        resolve: () => ({
    ...
    cleave: {
        ...
        category: "die-transform",
        timing: "on-kept-die",
        description: "Roll 2 Volatility Dice instead, taking the result furthest from the middle. If equidistant, take the higher.",
        shortLabel: "Cleave",
        resolve: (context) => ({
            reroll: {
    ...
    momentum: {
        ...
        description: "If the Stress from this roll would overflow your track, regain 1 Resistance if any have been spent. This does not prevent the Stress gained.",
        shortLabel: "Momentum",
        resolve: () => ({
            recoverResistance: 1,
    ...
    reversal: {
        ...
        category: "track",
        timing: "on-kept-die",
        description: "If activated within the jinx threshold, decrease Stress by 1, keeping the original success level if that would move the die outside the jinx threshold.",
        shortLabel: "Reversal",
        resolve: (context) => {
            ...
            return insideJinx && wouldBeOutside
                ? {
                    ...
                    lockBaseOutcome: true,
                    notes: [
                        "Reduced Stress by 1 and kept original success level change state."
                    ]
                }
    ...
    spite: {
        ...
        description: "Ignore the success level granted by this Volatility Die and instead add its value to a damage roll.",
        shortLabel: "Spite",
        resolve: (context) => ({
            lockBaseOutcome: true,
    ...
    fracture: {
        ...
        category: "die-transform",
        timing: "on-kept-die",
        description: "If activated while in the jinx threshold, the result is considered the die maximum. Otherwise, it is considered the die minimum.",
        shortLabel: "Fracture",
        resolve: (context) => ({
    ...
    tempt: {
        ...
        category: "modifier",
        timing: "on-kept-die",
        description: "If this Perk is exactly 1 above your current jinx threshold, increase success level by 2 instead of 1.",
        shortLabel: "Tempt",
        resolve: (context) => ({
            successModifier: context.keptFace === context.jinxThreshold + 1 ? 2 : undefined,
            notes: context.keptFace === context.jinxThreshold + 1
                ? ["Tempt increased the success level by 2."]
                : undefined
        })
    },
    charge: {
