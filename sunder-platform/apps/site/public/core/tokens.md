...
| Cost (Tokens) | Action Name | Effect                                                                                                                                                             |
| ------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1             | Push        | Grant yourself a Reroll as a reaction by flavoring the cost.\*                                                                                                     |
...
**Spirit Tokens** are a representation of the party's capability to work together towards a shared goal. These can be expended to recover one of an ally's Resistances in any Potential, but you must narrate how you have helped your ally into bringing this moment of success into fruition. Spending a Spirit Token for an Ability counts as the same cost reduction as spending a [[potentials-and-resistance|Resistance]], and some Loom Boons will require the expenditure of a Spirit Token specifically.
...
2. Clear 1 [[stress-and-fallout|Stress]] from each party member.
...
**Buff** - *before making a roll, add an additional [[volatility-and-perks|Volatility Die]]* (1/[[resting|Short Rest]])
**Recoup** - *during a [[resting|Short Rest]], expend a Spirit Token to regain a number of [[damage|Marks]] equal to a roll of your Nerve [[volatility-and-perks|Volatility Die]]* (1/[[resting|Long Rest]])
**Tutelage** - *add a [[volatility-and-perks|Volatility Die]] to an ally's roll if you have [[proficiencies|proficiency]] in a relative Domain* (1/[[resting|Long Rest]])
**Shared Fortune** - *on a [[resolution-system|Crit]], you may designate an ally to be given an extra [[volatility-and-perks|Volatility Die]] on their next roll* (1/[[resting|Long Rest]])
**Protective Instinct** - *when an ally takes [[stress-and-fallout|Fallout]], any one member of the party can be granted an extra [[volatility-and-perks|Volatility Die]] when that member takes an Action to protect the affected ally* (1/[[resting|Short Rest]])
**Bulwark** - *expend a Spirit Token when a close ally is affected with physical [[stress-and-fallout|Stress]] to take the [[stress-and-fallout|Stress]] instead of them*

[^1]: Your archetype and [[origin|background]] may also give you options for earning Flavor Tokens.