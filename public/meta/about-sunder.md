...
<div class="sunder-support-note">
  <div class="sunder-support-note__icon sunder-kofi-icon" aria-hidden="true">
    <svg viewBox="0 0 640 640" role="img" focusable="false" aria-hidden="true">
  ...
  <div class="sunder-support-note__body">
    <p class="sunder-support-note__title">Want to help Sunder grow?</p>
    <p class="sunder-support-note__text">
      If you enjoy the project and want to support future development, consider backing Sunder on Ko-Fi.
      <a
        href="https://ko-fi.com/sunderttrpg"
        target="_blank"
        rel="noopener"
        class="sunder-support-note__link"
      >
        Support Sunder
      </a>
    </p>
