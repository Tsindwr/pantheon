...
If your table is not used to players taking on a rewarding role such as this, you may use a hybrid GM system, where the GM rewards the players and when the players expend the Flavor Token, it is given to the GM to be used when they wish, then it returns to the ether.
### Earning Tokens
...
<div class="sunder-premium-slot" data-premium-slot="prm_tokens_advanced_flavor_actions">More Flavor Actions can be unlocked by purchasing Sunder Scription from Ko-Fi or PayPal!</div>

<div class="sunder-premium-slot" data-premium-slot="prm_tokens_party_loom"></div>

<div class="sunder-premium-slot" data-premium-slot="prm_tokens_loom_boons"></div>
